...
# Define the Perception Agent
class PerceptionAgent(Agent):
    def __init__(self, name, task_description):
        super().__init__(name=name)
        self.task_descriptiono = task_description
...
class ReasoningAgent(Agent):
    def solve_problem(self, context):
        # Use logic or AI methods to make decisions
        return {"solution": "Some reasoning output"}

# Define the Action Agent
class ActionAgent(Agent):
    def execute_action(self, decision):
        # Interact with AFLWorld using the decision
        return {"action_result": "Action executed"}
